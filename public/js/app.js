...
/* harmony import */ var _js_stripe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/stripe */ "./resources/js/stripe.js");
...
var userSuccessMsg = document.querySelector(".user-success-msg");
...
var userErrorMsg = document.querySelector("#user-error-msg");
...
function updateCart(product) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1___default().post("/cart/update", product).then(function (response) {
...
var cartFromDetail = document.querySelector("#product_addtocart_form");

if (cartFromDetail) {
  cartFromDetail.addEventListener("submit", function (e) {
    e.preventDefault();
    var formData = new FormData(cartFromDetail);
    var formObject = {};
    ...
    axios__WEBPACK_IMPORTED_MODULE_1___default().post("/cart/update", formObject).then(function (response) {
      new (noty__WEBPACK_IMPORTED_MODULE_0___default())({
        type: "success",
        timeout: 2000,
        text: "Item added to cart",
...
removeCartItem.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    axios__WEBPACK_IMPORTED_MODULE_1___default().post("/cart/delete", {
      itemId: btn.dataset.item
    }).then(function (response) {
      var cartRow = document.querySelector("#product_".concat(btn.dataset.item));
      cartRow.remove();

      if (Object.keys(response.data.data).length == 0) {
        var checkout_cart_button = document.querySelector("#checkout_cart_button");
...
(0,_js_stripe__WEBPACK_IMPORTED_MODULE_2__.stripe)();
...
function stripe() {
  return _stripe.apply(this, arguments);
}

function _stripe() {
  _stripe = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
    var stripe, card, mountWidget, coupon_code, paymentForm;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)("pk_test_51JAH5MSJQQR3TnHr96T2ZacIQwnIZqPVMbNXVIDRnhT2RUDUoz1r24MoVY18iTjqaS0acXs2MqDqXOxGetZ9x3Qg00WOqOlQlH");

          case 3:
            stripe = _context2.sent;
            card = null;
            coupon_code = document.querySelector("#coupon_code");
                      ...
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          stripe.createToken(card).then(function (result) {
                            formObject.stripeToken = result.token.id; //Place the order

                            axios__WEBPACK_IMPORTED_MODULE_3___default().post("/order/add", formObject).then(function (res) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkoxyfresh"] = self["webpackChunkoxyfresh"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["public/css/app"], () => (__webpack_require__("./resources/app.js")))
